...
import { setUsername, setPassword, setUsernameValidate, setPasswordValidate } from './actions'
...
const LoginForm = () => {
    ...
    useEffect(() => {
        ...
        getError?.type === 'password' && dispatched(setPasswordValidate(getError?.msg))
    }, [getError])
    ...
    return (
        <div className="login-container">
            ...
            <div className='login-to-register'>
                ...
                <Link to='/admin/register' className='login-link-register'>Đăng ký ngay</Link>
            </div>
        </div>
    )
}
