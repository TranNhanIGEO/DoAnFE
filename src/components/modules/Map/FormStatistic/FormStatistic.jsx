import { useCallback, useContext, useState, useReducer } from "react";
import { apiGetSchoolList, apiRenderChart } from 'src/redux//request/mapRequest';
...
const FormStatistic = () => {
    ...
    const handleSetLayer = async (e) => {
        ...
        const request = await apiGetSchoolList(params)
