...
import {ListGroupLayer, ListSelectLayer, ListRadioLocation, ListCheckPriority} from './data'
...
const FormEnrollment = () => {
    ...
    const handleSetLayer = (e) => {
        ...
        e.target.value === 'diemchuan_truongthuong_lopthuong'
    ...
    const handleResponseData = (res) => {
        ...
        switch (res.status) {
            ...
            toast('success', 'Tư vấn tuyển sinh thành công', 'Chúc bạn có một kỳ thi thật tốt!')
            break;
            ...
            <form onSubmit={(e) => handleSubmit(e)}>
                ...
                <Modal.Body>
                    <FormControl>
                        ...
                        >
                            {ListGroupLayer.map((group, index) => (
                                <FormSelect.OptionGroup 
                                    key={index} 
                                    label={group.label}
                                > 
                                {ListSelectLayer.map((layer, index) => group.label === layer.group && (
                                    <FormSelect.Option 
                                        key={index} 
                                        id={layer.id}
                                        value={layer.value}
